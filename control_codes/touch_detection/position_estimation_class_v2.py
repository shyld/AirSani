...
class pose_estimation:
	...
	def __init__(self):
		...
		#if not OPTIMIZED_MODEL.is_file():
...
####
	...
	def get_keypoints(self,image, print_element_names = False, show_list_keypoints = [10,11], show_touch_event = False, gamma = 1.0):
