...
pixel_steps = (64/5.62/2)/13.8*4.8
wait_before_photo = 3 # sec
...
#### Functions for two step steering
	...
	def two_step_steer(self, LED, x,y): # the light will automatically turn on
		...
		if (x**2 + y**2)<20**2:
			...
			return 0
		print('waiting for 10 sec before taking step 2')
		time.sleep(10)
		try:
