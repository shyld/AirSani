...
bkg1 = cv2.resize(cv2.imread('BKGA1.png',0), (width, height), interpolation = cv2.INTER_AREA)
bkg0 = cv2.resize(cv2.imread('BKGA0.png',0), (width, height), interpolation = cv2.INTER_AREA)
...
#                img1 = read_camera(left_camera,False)             # added by moh
           ...
           # Test Images From Files
img1 = cv2.resize(cv2.imread('IMGA1.png',0), (width, height), interpolation = cv2.INTER_AREA)
img0 = cv2.resize(cv2.imread('IMGA0.png',0), (width, height), interpolation = cv2.INTER_AREA)
