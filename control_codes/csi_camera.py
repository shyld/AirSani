...
class CSI_Camera:
    ...
    def open(self, gstreamer_pipeline_string):
        ...
        #print('updating self.frame in open', np.mean(self.frame,axis=(0,1))) #print(self.frame.mean(axis=0).mean(axis=0))
    ...
    def start(self):
        ...
        if self.video_capture != None:
            ...
            #print('video capturing started, updating camera in a thread')
    ...
    def updateCamera(self):
        ...
        while self.running:
            ...
            try:
                ...
                #print(frame.shape)
                #print('in UpdateCamera, updating self.frame', np.mean(self.frame,axis=(0,1)))
                with self.read_lock:
