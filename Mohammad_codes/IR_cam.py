...
class MyVideoCapture:
    ...
    def get_processed_IR_frame(self):
        ...
        try:
            ...
            #bkg1 = cv2.imread('BKGA1.png',0)
            #bkg0 = cv2.imread('BKGA0.png',0)
            ...
            if shared_variables.UV_Active = True
                ...
                img0 = cv2.cvtColor(bkg0, cv2.COLOR_BGR2GRAY)   # added by moh
                img1 = cv2.cvtColor(bkg1, cv2.COLOR_BGR2GRAY)   # added by moh         

                # Test Images From Files
                #img1 = cv2.imread('IMGA1.png',0)
                #img0 = cv2.imread('IMGA0.png',0)
